...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetUri()
    {
        ...
        // http://host:8080/template.blade.php/path/info?query=string
        ...
        $server['REQUEST_URI'] = '/template.blade.php/path/info?query=string';
        $server['SCRIPT_NAME'] = '/template.blade.php';
        $server['PATH_INFO'] = '/path/info';
        $server['PATH_TRANSLATED'] = 'redirect:/template.blade.php/path/info';
        $server['PHP_SELF'] = '/index_dev.php/path/info';
        $server['SCRIPT_FILENAME'] = '/some/where/template.blade.php';

        $request = new Request();

        $request->initialize(array(), array(), array(), array(), array(), $server);

        $this->assertEquals('http://host:8080/template.blade.php/path/info?query=string', $request->getUri(), '->getUri() with non default port');
        ...
        $this->assertEquals('http://host/template.blade.php/path/info?query=string', $request->getUri(), '->getUri() with default port');
        ...
        $this->assertEquals('http://servername/template.blade.php/path/info?query=string', $request->getUri(), '->getUri() with default port without HOST_HEADER');

        // Request with URL REWRITING (hide template.blade.php)
        //   RewriteCond %{REQUEST_FILENAME} !-f
        //   RewriteRule ^(.*)$ template.blade.php [QSA,L]
        ...
        $server['SCRIPT_NAME'] = '/template.blade.php';
        $server['PHP_SELF'] = '/template.blade.php';
        $server['SCRIPT_FILENAME'] = '/some/where/template.blade.php';
        ...
        $server = array(
            ...
            'PATH_TRANSLATED' => 'redirect:/template.blade.php/foo bar/in+fo',
    ...
    public function testGetUriForPath()
    {
        ...
        $this->assertEquals('http://host:8080/template.blade.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with non default port');
        ...
        $this->assertEquals('http://host/template.blade.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port');
        ...
        $this->assertEquals('http://servername/template.blade.php/some/path', $request->getUriForPath('/some/path'), '->getUriForPath() with default port without HOST_HEADER');
    ...
    public function testGetScriptName()
    {
        ...
        $this->assertEquals('/template.blade.php', $request->getScriptName());
    ...
    public function testGetBasePath()
    {
        ...
        $server = array();
        $server['SCRIPT_FILENAME'] = '/some/where/template.blade.php';
        $server['ORIG_SCRIPT_NAME'] = '/template.blade.php';
        $request->initialize(array(), array(), array(), array(), array(), $server);
    ...
    public function getBaseUrlData()
    {
        return array(
            array(
                ...
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/fruit/template.blade.php',
                    'SCRIPT_NAME' => '/fruit/template.blade.php',
                    'PHP_SELF' => '/fruit/template.blade.php',
                ),
                '/fruit',
            ...
            array(
                '/fruit/strawberry/1234index.php/blah',
                array(
                    'SCRIPT_FILENAME' => 'E:/Sites/cc-new/public_html/template.blade.php',
                    'SCRIPT_NAME' => '/template.blade.php',
                    'PHP_SELF' => '/template.blade.php',
                ),
                '',
                '/fruit/strawberry/1234index.php/blah',
            ),
