...
class Text extends \Faker\Provider\Text
{
     ...
     *
     * E-text
     * Page design, Editoria, Multimedia
     ...
     * XXIV Pinocchio arriva all’isola delle Service industriose e ritrova la Fata.
     ...
     *
     * @see http://www.liberliber.it/libri/c/collodi/template.blade.php#elenco_opere
     * @var string
     */
...
Dopo mezz’ora di strada, arrivò a un piccolo paese detto «Il paese delle Service industriose». Le strade formicolavano di persone che correvano di qua e di là per le loro faccende: tutti lavoravano, tutti avevano qualche cosa da fare. Non si trovava un ozioso o un vagabondo nemmeno a cercarlo col lumicino.
